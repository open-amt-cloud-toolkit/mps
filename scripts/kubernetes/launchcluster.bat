...
echo creating aks
call az aks create --resource-group %myResourceGroup% --name %myAksCluster% --node-count 3 --enable-addons monitoring --generate-ssh-keys && (
...
call az aks get-credentials --resource-group %myResourceGroup% --name %myAksCluster% && (
