...
export enum messages {
  ...
  APPUSEJSONPARSER_ERROR = 'appUseJsonParser received err other than SyntaxError',
  ...
  DEVICE_DISCONNECT_EXCEPTION = 'Excpetion during Device Disconnect',
  DEVICE_DISCONNECTED_SUCCESS = 'Device CIRA connection disconnected',
  DEVICE_GET_EXCEPTION = 'Exception during Device Get request',
  DEVICE_GETALL_EXCEPTION = 'Exception during Device Get All request',
  ...
  MPS_CIRA_NEW_TLS_CONNECTION = 'MPS: New TLS CIRA connection',
  ...
  MPS_USERAUTH_REQUEST = 'MPS: USERAUTH_REQUEST',
  MPS_PROTOCOLVERSION = 'MPS: PROTOCOLVERSION',
  ...
  MPS_SEND_SERIVCE_ACCEPT = 'MPS: SendServiceAccept',
  ...
  MPS_CONNECTION = 'MPS Connection, HTTP GET detected',
  MPS_CONNECTION_CLOSED = 'MPS:CIRA connection closed',
  MPS_ROOT_CERTIFICATE_DOES_NOT_EXIST = 'MPS root certificate does not exist',
  MPS_ROOT_CERTIFICATE_EXCEPTION = 'Excpetion during MPS Root Certificate download',
  ...
  SECRET_MANAGER_DATA_WRITEN_TO_SECRET_STORE_SUCCESS = 'Successfully wrote data to secret store at path',
  ...
  TLS_CONFIGURATION_WEBTLS_CONFIG_DOES_NOT_EXIST = 'webtls config file does not exist',
  ...
  TLS_CONFIGURATION_MPS_TLS_CONFIG_DOES_NOT_EXIST = 'mpstls config file does not exist',
  TLS_CONFIGURATION_MPS_TLS_CONFIGURATION_EXCEPTION = 'Exception in mpsTLSConfiguration',
  TLS_CONFIGURATION_DIRECTTLS_CONFIG_DOES_NOT_EXIST = 'directtls config file does not exist',
  TLS_CONFIGURATION_DIRECTTLS_CONFIGURATION_EXCEPTION = 'Exception in directTLSConfiguration',
