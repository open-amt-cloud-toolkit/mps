...
export enum messages {
  ...
  SECRET_MANAGER_ISSUE_CERTIFICATE_ERROR = 'Error while issue certificate',
  ...
  SECRET_MANAGER_WRITING_ISSUE_CERTIFICATE = 'writing issue certificate...',
  SECRET_MANAGER_DATA_CERTIFICATE_ISSUED_SUCCESS = 'Successfully issue certificate',
