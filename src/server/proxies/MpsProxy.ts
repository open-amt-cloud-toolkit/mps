...
export class MpsProxy implements IMpsProxy {
  ...
  static processCommand = (socket): any => {
    ...
    if (thisMsgLength > data.length) {
      ...
      if (APFProtocol.CHANNEL_OPEN === msgType) {
        ...
        if (typeof mpsproxyObject !== 'undefined') {
        ...
        const mpsproxyObject = MpsProxy.proxies[uuid]
        if (typeof mpsproxyObject !== 'undefined') {
          if (typeof mpsproxyObject.channels[mpsproxyChannelid] === 'undefined') {
  ...
  static async getProxySocket (mpsServerIP: string, mpsservice: MPSMicroservice): Promise<any> {
    ...
    if (typeof MpsProxy.sockets[mpsServerIP] === 'undefined' || MpsProxy.sockets[mpsServerIP].destroyed) {
  ...
  static async getSocketForGuid (guid: string, mpsservice: MPSMicroservice): Promise<any> {
    // get MPS server IP
