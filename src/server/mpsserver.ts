...
export class mpsServer{
    ...
    processCommand = (socket) => {
        ...
        switch (cmd) {
            ...
            case APFProtocol.USERAUTH_REQUEST: {
                ...
                let username = data.substring(5, 5 + usernameLen);
    ...
    debug(lvl: number, ...argArray: string[]) {
          ...
          if (argArray.length == 1) { log.debug(argArray[0]); }
          else if (argArray.length == 2) {log.debug(`${argArray[0]} ${argArray[1]}`);}
          else if (argArray.length == 3) { log.debug(`${argArray[0]} ${argArray[1]} ${argArray[2]}`); }
          else if (argArray.length == 4) { log.debug(`${argArray[0]} ${argArray[1]} ${argArray[2]} ${argArray[3]}`); }
          else if (argArray.length == 5) { log.debug(`${argArray[0]} ${argArray[1]} ${argArray[2]} ${argArray[3]} ${argArray[4]}`); }
          else if (argArray.length == 6) { log.debug(`${argArray[0]} ${argArray[1]} ${argArray[2]} ${argArray[3]} ${argArray[4]} ${argArray[5]}`); }
    }
