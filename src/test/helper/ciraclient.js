...
module.exports.CreateCiraClient = function (parent, args) {
  ...
  function SendProtocolVersion(socket, uuid) {
    ...
    var data =
      ...
      '' +
      obj.common.IntToStr(1) +
      obj.common.IntToStr(0) +
      obj.common.IntToStr(0) +
      obj.common.hex2rstr(buuid) +
      Buffer.alloc(64)
  ...
  function SendUserAuthRequest(socket, user, pass) {
    ...
    var data =
      ...
      obj.common.IntToStr(user.length) +
      user +
      obj.common.IntToStr(service.length) +
      service
    //password auth
  ...
  function SendGlobalRequestPfwd(socket, amthostname, amtport) {
    ...
    var data =
      String.fromCharCode(APFProtocol.GLOBAL_REQUEST) +
      obj.common.IntToStr(tcpipfwd.length) +
      tcpipfwd +
      Buffer.alloc(1, 1)
