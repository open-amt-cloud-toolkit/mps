...
describe('auditLog', () => {
  ...
  it('should return 200 in happy path', async () => {
    ...
    jest.spyOn(devices[fakeGuid], 'getAuditLog').mockResolvedValue(fakePullResponseWithRecords)
  ...
  it('should return 500 on exception', async () => {
    devices[fakeGuid] = new ConnectedDevice(null, 'admin', 'P@ssw0rd')
    jest.spyOn(devices[fakeGuid], 'getAuditLog').mockResolvedValue(() => {
      throw new Error()
    })
